...
#  merchant_id                        :bigint(8)        default(0)
#  merchant_name                      :string(255)      default("")
#  merchant_canonical_name            :string(255)      default("")
#  merchant_status                    :integer          default(0)
#  merchant_salesforce_id             :string(255)      default("0")
#  merchant_notification_email        :string(255)      default("")
#  domain_id                          :bigint(8)        default(0)
#  domain_fqdn                        :string(255)      default("")
#  domain_status                      :integer          default(0)
#  domain_active                      :boolean          default(TRUE)
#  site_id                            :bigint(8)        default(0)
#  site_cover_image                   :string(255)      default("")
#  site_logo                          :string(255)      default("")
#  site_about_us                      :text(65535)
...
#  merchant_shipping                  :string(255)      default("")
#
# Indexes
#
